...
s
        ...
        />
        <SecondSection  text="O Ship from Store garante que seus pedidos sejam enviados diretamente das lojas físicas mais próximas, reduzindo o tempo de entrega e aumentando a eficiência. Realizado por um time majoritariamente composto por mulheres, não só melhora a eficiência logística, como combina a excelência operacional, com uma forte responsabilidade social. Ao optar por esse serviço da UX em conexão com a Venuxx, você promove a inclusão feminina no mercado de trabalho e desfruta de uma entrega rápida e confiável." title="Eficiência e Inclusão" flowReverse={false} image={vennux.src} link="https://venuxx.com/" corButtonOne="#fac30c" corButtonTwo="#fe8012" />
        <ThreeTopics
