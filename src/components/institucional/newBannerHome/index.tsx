            ...
            <div className="flex flex-col w-full items-center justify-center">
                ...
                <div className="flex h-full items-center justify-center w-full lg:flex-col flex-col-reverse">
                    ...
                    <motion.div
                        ...
                        <div className="h-10">
                            <Image style={{ borderTopRightRadius: `${currentIndex === banners[currentIndex].index ? "10px" : "rounded-3xl"}` }} className={`${banners[currentIndex].index === 3 ? "lg:w-full w-[40%] " : "w-full"} `} src={banners[currentIndex].svgIcon} alt="" width={100} height={100} />
                        </div>
