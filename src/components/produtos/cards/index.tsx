        ...
        <section className="bg-white lg:h-auto max-w-[1996px] pb-[100px] lg:pb-[5%] lg:pt-[15%] pt-[10%] xl:pt-[03%] w-full  ">
            <div className="flex w-full items-center justify-center">
                <div className="w-[90%] flex lg:flex-row flex-col items-center gap-5 justify-center">
                    <div className="flex flex-col justify-center items-center h-auto lg:h-[600px] w-full lg:w-1/2 border rounded-2xl shadow-md">
                        <div style={{ backgroundImage: `url(${vendasBanner.src})`, backgroundRepeat: "no-repeat", backgroundSize: "cover" }} className=" h-[200px] lg:h-[300px] w-full  flex items-center justify-center lg:justify-start rounded-t-2xl shadow-sm">
                            <div className="flex items-center justify-center lg:justify-start rounded-t-2xl lg:pl-20 w-full h-full bg-[#00000069]">
                                <Image width={100} height={100} className="w-2/5" src={unbox.src} alt="Unbox Logo" />
                            </div>

                        </div>
                        <div className="h-auto py-10 px-5 lg:p-10 w-[90%]">
